...
void plain_trsv(const int argc, const char *argv[], ALPHA_INT m, ALPHA_INT n, ALPHA_INT nnz, ALPHA_INT *row_index, ALPHA_INT *col_index, double *values, double *x, double alpha, double *y, int thread_num, int flag)
{
...
void alpha_trsv(const int argc, const char *argv[], ALPHA_INT m, ALPHA_INT n, ALPHA_INT nnz, ALPHA_INT *row_index, ALPHA_INT *col_index, double *values, double *x, double alpha, double *y, int thread_num, int flag)
{
    alpha_set_thread_num(thread_num);
    ...
    alpha_call_exit(alphasparse_d_trsv(transA, alpha, bsrA, descr, x, y), "alphasparse_d_trsv");
