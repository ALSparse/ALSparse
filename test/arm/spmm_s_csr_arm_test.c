...
static void alpha_plain_spmm(const int argc, const char *argv[], ALPHA_INT m, ALPHA_INT n, ALPHA_INT nnz, ALPHA_INT *row_index, ALPHA_INT *col_index, float *values, alphasparse_index_base_t *ret_index, ALPHA_INT *ret_rows, ALPHA_INT *ret_cols, ALPHA_INT **ret_rows_start, ALPHA_INT **ret_rows_end, ALPHA_INT **ret_col_index, float **ret_values, int thread_num)
{
...
int main(int argc, const char *argv[])
{
    ...
    if (check)
    {
        ...
        status = check_s_l3((float * )alpha_values, 0, alpha_nnz, alpha_values, 0, alpha_plain_nnz, alpha_col_index, NULL, 0, alpha_plain_values, 0, alpha, beta, argc, argv);    
