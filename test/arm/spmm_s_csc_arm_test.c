...
static void alpha_plain_spmm(const int argc, const char *argv[], alphasparse_index_base_t *ret_index, ALPHA_INT *ret_rows, ALPHA_INT *ret_cols, ALPHA_INT **ret_rows_start, ALPHA_INT **ret_rows_end, ALPHA_INT **ret_col_index, float **ret_values, int thread_num)
{
    ALPHA_INT m, n, nnz;
    ALPHA_INT *row_index, *col_index;
    float *values;
    const char *fileA = args_get_data_fileA(argc, argv);
    alpha_read_coo(fileA, &m, &n, &nnz, &row_index, &col_index, &values);
    ...
    alpha_read_coo(fileB, &m, &n, &nnz, &row_index, &col_index, &values);
    ...
    alpha_call_exit(alphasparse_s_export_csc(result, ret_index, ret_rows, ret_cols, ret_rows_start, ret_rows_end, ret_col_index, ret_values), "alphasparse_s_export_csc");
...
static void alpha_spmm(const int argc, const char *argv[], alphasparse_index_base_t *ret_index, ALPHA_INT *ret_rows, ALPHA_INT *ret_cols, ALPHA_INT **ret_rows_start, ALPHA_INT **ret_rows_end, ALPHA_INT **ret_col_index, float **ret_values, int thread_num)
{
    ALPHA_INT m, n, nnz;
    ALPHA_INT *row_index, *col_index;
    float *values;
    ...
    alpha_call_exit(alphasparse_spmm(transA, cscA, cscB, &result), "alphasparse_spmm");
...
int main(int argc, const char *argv[])
{
    ...
    if (check)
    {
        ...
        status = check_s(alpha_plain_values, alpha_plain_nnz, alpha_values, alpha_nnz);
    }
