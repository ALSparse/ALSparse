...
static void alpha_mv()
{
    ...
    alpha_call_exit(alphasparse_uni_d_create_coo(&cooA, ALPHA_SPARSE_EXE_HOST, ALPHA_SPARSE_INDEX_BASE_ZERO, m, k, nnz, row_index, col_index, values), "alphasparse_d_create_coo");
    alpha_call_exit(alphasparse_uni_convert_csr(cooA, ALPHA_SPARSE_OPERATION_NON_TRANSPOSE, &csrA), "alphasparse_convert_csr");
    alpha_call_exit(alphasparse_uni_convert_coo(csrA, ALPHA_SPARSE_OPERATION_NON_TRANSPOSE, &cooB), "alphasparse_convert_coo");
    alpha_call_exit(alphasparse_uni_convert_csr(cooB, ALPHA_SPARSE_OPERATION_NON_TRANSPOSE, &csrB), "alphasparse_convert_csr");
    ...
    for (int i = 0; i < iter; i++)
    {
        ...
        alpha_call_exit(alphasparse_uni_d_mv(transA, alpha, csrB, descr, x, beta, icty), "alphasparse_d_mv");
