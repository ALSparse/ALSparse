...
void plain_trsv(const int argc, const char *argv[], ALPHA_INT m, ALPHA_INT n, ALPHA_INT nnz, ALPHA_INT *row_index, ALPHA_INT *col_index, ALPHA_Complex16 *values, ALPHA_Complex16 *x, ALPHA_Complex16 alpha, ALPHA_Complex16 *y, int thread_num, int flag)
{
    ...
    alpha_call_exit(alphasparse_z_trsv_plain(transA, alpha, bsrA, descr, x, y), "alphasparse_z_trsv_plain");
...
void alpha_trsv(const int argc, const char *argv[], ALPHA_INT m, ALPHA_INT n, ALPHA_INT nnz, ALPHA_INT *row_index, ALPHA_INT *col_index, ALPHA_Complex16 *values, ALPHA_Complex16 *x, ALPHA_Complex16 alpha, ALPHA_Complex16 *y, int thread_num, int flag)
{
    alpha_set_thread_num(thread_num);
    ...
    alpha_call_exit(alphasparse_z_trsv(transA, alpha, bsrA, descr, x, y), "alphasparse_z_trsv");
