...
static void alpha_plain_spmm(const int argc, const char *argv[], alphasparse_index_base_t *ret_index, ALPHA_INT *ret_rows, ALPHA_INT *ret_cols, ALPHA_INT **ret_rows_start, ALPHA_INT **ret_rows_end, ALPHA_INT **ret_col_index, ALPHA_Complex16 **ret_values, int thread_num)
{
    ALPHA_INT m, n, nnz;
    ...
    alpha_call_exit(alphasparse_spmm_plain(transA, cscA, cscB, &result), "alphasparse_z_spmm_plain");

    alpha_timing_end(&timer);
    alpha_timing_elaped_time_print(&timer, "alphasparse_z_spmm_plain");

    alpha_call_exit(alphasparse_z_export_csc(result, ret_index, ret_rows, ret_cols, ret_rows_start, ret_rows_end, ret_col_index, ret_values), "alphasparse_z_export_csc");
...
static void alpha_spmm(const int argc, const char *argv[], alphasparse_index_base_t *ret_index, ALPHA_INT *ret_rows, ALPHA_INT *ret_cols, ALPHA_INT **ret_rows_start, ALPHA_INT **ret_rows_end, ALPHA_INT **ret_col_index, ALPHA_Complex16 **ret_values, int thread_num)
{
    ALPHA_INT m, n, nnz;
    ALPHA_INT *row_index, *col_index;
    ALPHA_Complex16 *values;
    ...
    alpha_call_exit(alphasparse_spmm(transA, cscA, cscB, &result), "alphasparse_z_spmm");

    alpha_timing_end(&timer);
    alpha_timing_elaped_time_print(&timer, "alphasparse_z_spmm");
