...
static void mkl_mm(const int argc, const char *argv[], const char *file, int thread_num, float alpha, float beta, float **ret_y, size_t *ret_size_y)
{
    ...
    mkl_call_exit(mkl_sparse_s_mm(transA, alpha, bsr, descr, layout, x, columns, ldx, beta, y, ldy), "mkl_sparse_s_mm");
...
static void alpha_mm(const int argc, const char *argv[], const char *file, int thread_num, float alpha, float beta, float **ret_y, size_t *ret_size_y)
{
    ...
    alpha_call_exit(alphasparse_s_create_coo(&coo, ALPHA_BASE, m, k, nnz, row_index, col_index, values), "alphasparse_s_create_coo");
    ...
    alpha_call_exit(alphasparse_s_mm_plain(transA, alpha, bsr, descr, layout, x, columns, ldx, beta, y, ldy), "alphasparse_s_mm");
