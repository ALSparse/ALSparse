...
static void mkl_mm(const int argc, const char *argv[], const char *file, int thread_num, MKL_Complex8 alpha, MKL_Complex8 beta, MKL_Complex8 **ret_y, size_t *ret_size_y)
{
    ...
    mkl_call_exit(mkl_sparse_c_create_coo(&coo, base, m, k, nnz, row_index, col_index, values), "mkl_sparse_c_create_coo");
    ...
    mkl_call_exit(mkl_sparse_c_mm(transA, alpha, bsr, descr, layout, x, columns, ldx, beta, y, ldy), "mkl_sparse_c_mm");
...
static void alpha_mm(const int argc, const char *argv[], const char *file, int thread_num, ALPHA_Complex8 alpha, ALPHA_Complex8 beta, ALPHA_Complex8 **ret_y, size_t *ret_size_y)
{
    ...
    alpha_call_exit(alphasparse_c_create_coo(&coo, ALPHA_BASE, m, k, nnz, row_index, col_index, values), "alphasparse_c_create_coo");
    ...
    alpha_call_exit(alphasparse_c_mm_plain(transA, alpha, bsr, descr, layout, x, columns, ldx, beta, y, ldy), "alphasparse_c_mm");
