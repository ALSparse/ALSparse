...
static void mkl_gthrz(const MKL_INT n, double * x, const MKL_INT* indx, double *y, int thread_num)
{
...
int main(int argc,const char *argv[])
{
    ...
    double *mkl_x = alpha_memalign(sizeof(double) * mkl_n, DEFAULT_ALIGNMENT);
    ...
    double *mkl_y = alpha_memalign(sizeof(double) * mkl_n * 20, DEFAULT_ALIGNMENT);
