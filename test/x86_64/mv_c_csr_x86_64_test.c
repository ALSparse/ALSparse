...
static void alpha_mv(const int argc, const char *argv[], const char *file, int thread_num, const ALPHA_Complex8 alpha, const ALPHA_Complex8 beta, ALPHA_Complex8 **ret_y, size_t *ret_size_y, ALPHA_Complex8 **ret_x, size_t *ret_size_x)
{
    ALPHA_INT m, k, nnz;
