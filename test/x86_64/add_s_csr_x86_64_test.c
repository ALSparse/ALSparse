...
static void mkl_add(const int argc, const char *argv[], const char *file, float alpha, sparse_index_base_t *ret_index, MKL_INT *ret_rows, MKL_INT *ret_cols, MKL_INT **ret_rows_start, MKL_INT **ret_rows_end, MKL_INT **ret_col_index, float **ret_values, int thread_num)
{
    MKL_INT m, k, nnz;
