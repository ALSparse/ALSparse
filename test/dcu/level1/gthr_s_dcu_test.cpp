...
static void roc_gthr()
{
    ...
    roc_call_exit(rocsparse_sgthr(handle, nnz, dy, dx_val, dx_idx, rocsparse_index_base_zero),
                  "rocsparse_sgthr");
...
static void alpha_gthr()
{
    ...
    // Call rocsparse csrmv
    alphasparse_dcu_s_gthr(handle, nnz, dy, dx_val, dx_idx, ALPHA_SPARSE_INDEX_BASE_ZERO);
