...
static void roc_axpyi()
{
    ...
    roc_call_exit(rocsparse_saxpyi(handle, idx_n, &alpha, dx_val, dx_idx, dy, rocsparse_index_base_zero),
                  "rocsparse_saxpyi");
...
static void alpha_axpyi()
{
    ...
    // Call rocsparse csrmv
    alphasparse_dcu_s_axpyi(handle, idx_n, &alpha, dx_val, dx_idx, dy, ALPHA_SPARSE_INDEX_BASE_ZERO);
