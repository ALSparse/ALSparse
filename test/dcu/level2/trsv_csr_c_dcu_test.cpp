...
static void roc_trsv_dcu()
{
    ...
    rocsparse_ccsrsv_buffer_size(handle, roctransA, m, nnz, descrA, dAval, dAptr, dAcol, info, &buffer_size);
    ...
    roc_call_exit(
        rocsparse_ccsrsv_analysis(handle, roctransA, m, nnz, descrA, dAval, dAptr, dAcol, info, rocsparse_analysis_policy_reuse, rocsparse_solve_policy_auto, temp_buffer),
    ...
    for (int i = 0; i < warm_up; ++i) {
        ...
        roc_call_exit(
            rocsparse_ccsrsv_solve(handle, roctransA, m, nnz, &halpha, descrA, dAval, dAptr, dAcol, info, dx, dy, rocsparse_solve_policy_auto, temp_buffer),
...
static void alpha_trsv_dcu()
{
    ...
    for (int i = 0; i < warm_up; ++i) {
        ...
        alpha_call_exit(
            alphasparse_dcu_c_csrsv_solve(handle, transA, m, nnz, &halpha, descrA, dAval, dAptr, dAcol, NULL, dx, dy, ALPHA_SPARSE_DCU_SOLVE_POLICY_AUTO, NULL),
            "alphasparse_dcu_c_csrsv_solve");
    }
