...
alphasparse_status_t convert_csr_datatype_coo(const alpha_internal_spmat *source, alpha_internal_spmat **dest, alphasparse_datatype_t datatype)
{
    if (datatype == ALPHA_SPARSE_DATATYPE_FLOAT)
    {
        return convert_csr_s_coo((spmat_coo_s_t *)source, (spmat_csr_s_t **)dest);
    }
    else if (datatype == ALPHA_SPARSE_DATATYPE_DOUBLE)
    {
        return convert_csr_d_coo((spmat_coo_d_t *)source, (spmat_csr_d_t **)dest);
    }
    else if (datatype == ALPHA_SPARSE_DATATYPE_FLOAT_COMPLEX)
    {
        return convert_csr_c_coo((spmat_coo_c_t *)source, (spmat_csr_c_t **)dest);
    }
    else if (datatype == ALPHA_SPARSE_DATATYPE_DOUBLE_COMPLEX)
    {
        return convert_csr_z_coo((spmat_coo_z_t *)source, (spmat_csr_z_t **)dest);
    }
    else
    {
...
// alphasparse_status_t convert_csr_datatype_csr(const alpha_internal_spmat *source, alpha_internal_spmat **dest, alphasparse_datatype_t datatype)
// {
//     if (datatype == ALPHA_SPARSE_DATATYPE_FLOAT)
//     {
...
// alphasparse_status_t convert_csr_datatype_csc(const alpha_internal_spmat *source, alpha_internal_spmat **dest, alphasparse_datatype_t datatype)
// {
//     if (datatype == ALPHA_SPARSE_DATATYPE_FLOAT)
//     {
...
// alphasparse_status_t convert_csr_datatype_bsr(const alpha_internal_spmat *source, alpha_internal_spmat **dest, alphasparse_datatype_t datatype)
// {
//     if (datatype == ALPHA_SPARSE_DATATYPE_FLOAT)
//     {
...
alphasparse_status_t convert_csr_datatype_format(const alpha_internal_spmat *source, alpha_internal_spmat **dest, alphasparse_datatype_t datatype, alphasparse_format_t format)
{
...
alphasparse_status_t alphasparse_convert_csr(const alphasparse_matrix_t source,       /* convert original matrix to CSR representation */
                                           ...
                                           alphasparse_matrix_t *dest)
{
    ...
    *dest = dest_;
    ...
    {
        return convert_csr_datatype_format((const alpha_internal_spmat *)source->mat, (alpha_internal_spmat **)&dest_->mat, source->datatype, source->format);
    }
    else if (operation == ALPHA_SPARSE_OPERATION_TRANSPOSE)
    {
        ...
        status = convert_csr_datatype_format((const alpha_internal_spmat *)AA->mat, (alpha_internal_spmat **)&dest_->mat, AA->datatype, AA->format);
