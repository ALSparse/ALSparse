...
trmm_coo_u_lo_col_transXY(const ALPHA_Number alpha, const ALPHA_SPMAT_COO *mat, const ALPHA_Number *x, const ALPHA_INT columns, const ALPHA_INT ldx, const ALPHA_Number beta, ALPHA_Number *y, const ALPHA_INT ldy)
{
    ...
    trmm_coo_u_lo_row(alpha, mat, X_, columns, ldX, beta, Y_, ldY); //alpha,mat,X,columns,ldX,beta,Y,ldY
...
{
    return trmm_coo_u_lo_col_transXY(alpha, mat, x, columns, ldx, beta, y, ldy);
}