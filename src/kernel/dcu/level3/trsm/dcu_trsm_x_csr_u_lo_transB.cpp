      ...
      void *temp_buffer)
{
    ...
    hipLaunchKernelGGL((trsm_opt_SM<blockdim>), dim3(griddim), dim3(blockdim), 0, handle->stream, csr_row_ptr, csr_col_ind, csr_val, m, nrhs, nnz, alpha, B, ldb, get_value);
