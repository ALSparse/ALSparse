...
* details:
* trmv_csr_n_lo_row         triangular row major matrics defined in csr, calculate lower triangle including diagal
* trmv_csr_u_lo_row         triangular row major matrics defined in csr, calculate lower triangle excluding diagal
* trmv_csr_n_hi_row         triangular row major matrics defined in csr, calculate higher triangle excluding diagal
* trmv_csr_u_hi_row         triangular row major matrics defined in csr, calculate higher triangle excluding diagal
* trmv_csr_n_lo_col         triangular column major matrics defined in csr, calculate lower triangle including diagal
* trmv_csr_u_lo_col         triangular column major matrics defined in csr, calculate lower triangle excluding diagal 
* trmv_csr_n_hi_col         triangular column major matrics defined in csr, calculate higher triangle excluding diagal
* trmv_csr_u_hi_col         triangular column major matrics defined in csr, calculate higher triangle excluding diagal
* trmv_csr_n_lo_row_conj    Conjugate transpose triangular row major matrics defined in csr, calculate lower triangle including diagal
* trmv_csr_u_lo_row_conj    Conjugate transpose triangular row major matrics defined in csr, calculate lower triangle excluding diagal
* trmv_csr_n_hi_row_conj    Conjugate transpose triangular row major matrics defined in csr, calculate higher triangle excluding diagal
* trmv_csr_u_hi_row_conj    Conjugate transpose triangular row major matrics defined in csr, calculate higher triangle excluding diagal
* trmv_csr_n_lo_col_conj    Conjugate transpose triangular column major matrics defined in csr, calculate lower triangle including diagal
* trmv_csr_u_lo_col_conj    Conjugate transpose triangular column major matrics defined in csr, calculate lower triangle excluding diagal 
* trmv_csr_n_hi_col_conj    Conjugate transpose triangular column major matrics defined in csr, calculate higher triangle excluding diagal
* trmv_csr_u_hi_col_conj    Conjugate transpose triangular column major matrics defined in csr, calculate higher triangle excluding diagal
*
* y := alpha*inv(op(A))*x
*
...
* Solve a set of equations in which a sparse matrix and a dense matrix are multiplied
* details:
* diagmv_csr_n_row          diagonal row major matrics defined in csr, including diagal
* diagmv_csr_u_row          diagonal row major matrics defined in csr, excluding diagal
* diagmv_csr_n_col          diagonal column major matrics defined in csr, including diagal
* diagmv_csr_u_col          diagonal column major matrics defined in csr, excluding diagal
*
* y := alpha*inv(op(A))*x
*
* alpha         a scalor value
