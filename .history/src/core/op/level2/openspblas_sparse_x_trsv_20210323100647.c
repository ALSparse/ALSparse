/**
 * @brief implement for openspblas_sparse_?_trsv intelface
...
/*
* 
* Solve the equation of the matrix
*
* details:
...
/*
* 
* Solve the thread equation of the matrix
*
* details:
...
/*
* 
* Solve the equations of a sparse matrix with a dense vector
*
* details:
